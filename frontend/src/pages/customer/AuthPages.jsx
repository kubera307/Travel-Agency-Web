      ...
      <div className="space-y-6 rounded-[28px] border border-[#e8dfd5] bg-[#fffdf9] p-8 shadow-[0_20px_45px_rgba(15,23,42,0.08)]">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full rounded-xl bg-[#d97706] py-3.5 text-xs font-bold text-white shadow-[0_10px_22px_rgba(217,119,6,0.2)] transition-all hover:-translate-y-0.5 hover:bg-[#c86a00] disabled:opacity-50"
          >
